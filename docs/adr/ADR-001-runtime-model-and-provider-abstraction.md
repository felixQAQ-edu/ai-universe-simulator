...
| 缓存命中率 | ~30% | 观察项 | 👀 |
| 可用性(错误率) | 0% | <1% | ✅ |
| 中文叙事质量 | 综合 ~4.4(世界组 4.35 / 路径组 4.67) | 均分≥4.0 | ✅ |

> **指标 #4 盲评备注(2026-06-18,据 ADR §6 rubric 人工盲评 8 世界 + 3 路径)**:综合均分
> ~4.4 通过(文笔 5.0、连贯 4.64、抉择 4.55、巧思 4.45 均稳)。**唯一软肋:世界组「沉浸感
> 与氛围」3.25(<3.5)**——根因是 bake-off 用单一种子(雨夜便利店)反复生成致桥段套路化,
> 非便利店场景(民宿/医院/地铁)沉浸感 4.33 明显更高。属种子/提示词多样性问题,非模型能力
> 短板,已记 [bakeoff/FINDINGS.md](../../bakeoff/FINDINGS.md) F-005 挂 Phase 1 world-gen 待办,
> **不影响本 ADR 的主力 provider 决策**。
...
4. ✅ 人工盲评中文叙事质量(指标 #4):综合 ~4.4 通过,沉浸感软肋记 F-005 挂 Phase 1(A3 规则质量可继续对 eval-key 复核)。
